...
namespace _5951071008_TranQuangDuy.Models
{
    public class db
    {
        //Data Source=DESKTOP-TQD\SQLEXPRESS;Initial Catalog=Demo_CRUD;Integrated Security=True
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-TQD\SQLEXPRESS;Initial Catalog=Demo_CRUD;Integrated Security=True");
